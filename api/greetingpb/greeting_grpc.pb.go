...
type GreetingClient interface {
	SayHello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingReply, error)
}
...
func (c *greetingClient) SayHello(ctx context.Context, in *GreetingRequest, opts ...grpc.CallOption) (*GreetingReply, error) {
...
type GreetingServer interface {
	SayHello(context.Context, *GreetingRequest) (*GreetingReply, error)
...
func (UnimplementedGreetingServer) SayHello(context.Context, *GreetingRequest) (*GreetingReply, error) {
